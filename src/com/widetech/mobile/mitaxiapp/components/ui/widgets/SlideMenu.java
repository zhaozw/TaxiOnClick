...
/**
 * Created with IntelliJ IDEA. User: AnderWeb Date: 2/4/13 Time: 8:51 AM
 */
public class SlideMenu extends NineFrameLayout {
	...
	protected void setCurrentPosition(float offset) {
		...
		final float current = Math.max(0,
				Math.min(max, getCurrentPosition() - offset));
